...
CSS stylesheet to use for HTML output, in addition to the built-in stylesheet
...
CSS stylesheet to use for Word output, in addition to the built-in stylesheet
for the particular Metanorma flavour, as an override [added in https://github.com/metanorma/isodoc/releases/tag/v1.6.0].
