...
`:docsubtype:`:: subtype of document [added in https://github.com/metanorma/metanorma-iec/releases/tag/v1.2.9].
Applies only to `international-standard`. The permitted types are:
